...
6. Embed the prompt and reject near-duplicates within the same route.
...
Exact string dedupe is not enough for synthetic data. Embedding similarity catches prompts that are
worded differently but ask nearly the same thing.
