...
DistanceScore = NewType("DistanceScore", float)
...
GeneratorBackend = NewType("GeneratorBackend", str)
GenerationHarnessName = NewType("GenerationHarnessName", str)
GroupKey = NewType("GroupKey", str)
InstitutionType = NewType("InstitutionType", str)
ModelName = NewType("ModelName", str)
ModelServerUrl = NewType("ModelServerUrl", str)
OllamaBaseUrl = NewType("OllamaBaseUrl", str)
OpenAIApiKey = NewType("OpenAIApiKey", str)
OpenAIBaseUrl = NewType("OpenAIBaseUrl", str)
